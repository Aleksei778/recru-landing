    ...
    <>
      <section className="space-y-4">
        ...
        <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-lg font-medium">
          We help producers, musicians, and rights holders protect their
          creative work from unauthorized use. Our team processes DSP complaints
          and manages takedowns across all major platforms for{" "}
          <span className="font-semibold text-blue-500 dark:text-cyan-300">
            tracks, cover art, podcasts, videos, and written content
          </span>{" "}
      ...
      <section className="relative flex items-start gap-6 p-6 my-8 border rounded-2xl shadow-sm dark:border-gray-700 dark:bg-gray-800/50">
        ...
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
            Jordan Tennant is a Music Entrepreneur who is the Co Founder of
            Tenty. He helps producers and songwriters with DSP takedowns. 3
            years experience in Music Industry
          </p>
        </div>
      </section>
