  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-10">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold mb-6">Tenty Request #{req.id}</h1>

        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow space-y-5">
          <p>
            <b>Track Link:</b> {req.track_link}
          </p>
          <p>
            <b>Artist Nickname:</b> {req.artist_nickname}
          </p>
          <p>
            <b>Track name:</b> {req.track_name}
          </p>
          <p>
            <b>Rights holder:</b> {req.rights_holder}
          </p>
          <p>
            <b>Name:</b> {req.full_name}
          </p>
          <p>
            <b>Email:</b> {req.email}
          </p>
