  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center gap-8 bg-gradient-to-br from-sky-50 to-indigo-100 dark:from-slate-900 dark:to-sky-800 relative overflow-hidden transition-colors duration-300 pt-45 pb-16">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute top-1/4 -right-10 w-20 h-20 bg-indigo-200 rounded-full opacity-30 animate-float"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute bottom-1/3 left-1/4 w-16 h-16 bg-indigo-300 rounded-full opacity-25 animate-float"
      ...
      <div className="text-center z-10 bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-white/20 animate-fade-in dark:bg-slate-800/70 dark:border-slate-700">
        ...
        >
          ...
          <div
            className={`absolute inset-0 bg-gradient-to-r from-sky-500 to-indigo-500 rounded-xl transition-all duration-300 ${isHovered ? "opacity-100" : "opacity-0"}`}
          ></div>
          ...
          <div className="relative z-10 flex items-center justify-center gap-3">
            ...
            <span
              className={
                isHovered ? "text-white" : "text-gray-700 dark:text-gray-100"
              }
            >
