      ...
      <div className="relative max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
        ...
        <div className="flex-1 z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            {features.map(
              ({ icon: Icon, title, desc, gradient, iconBg }, i) => (
                <div
                  key={i}
                ...
                >
                  ...
                  <div className="relative">
                    <div className="inline-flex items-center justify-center mb-4">
                      <div
                        className={`relative ${iconBg} w-14 h-14 rounded-xl flex items-center justify-center`}
                      >
                        <Icon
                          className="w-7 h-7"
                          style={{
                    ...
                    <h3
                      className="text-xl font-bold mb-3 dark:text-white text-gray-800 dark:text-white"
                      style={{
