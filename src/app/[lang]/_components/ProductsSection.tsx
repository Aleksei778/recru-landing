      ...
      <div className="container mx-auto relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            {t("productsSubtitle") ||
              "Мощные инструменты для эффективной email-рассылки"}
          </p>
        </div>
              ...
              >
                ...
                <div className="flex-1">
                  <div className="relative inline-flex mb-4">
                    <div
                      className={`absolute inset-0 bg-gradient-to-br ${product.gradient} rounded-xl blur-lg opacity-30 group-hover:opacity-50 transition-opacity duration-300`}
                    ></div>
                  ...
                  <h3
                    className="text-xl font-bold mb-3 dark:text-white group-hover:text-transparent group-hover:bg-gradient-to-br group-hover:bg-clip-text transition-all duration-300"
                    style={{
                      backgroundImage: `linear-gradient(135deg, ${product.gradient})`,
                    }}
                  >
                    {t(product.titleKey)}
                  </h3>
                ...
                <div className="mt-auto pt-4 border-t border-gray-100 dark:border-gray-700/50">
                  ...
                  >
                    <div
                      className={`absolute inset-0 bg-gradient-to-r ${product.gradient} opacity-5 group-hover/link:opacity-10 transition-opacity duration-300`}
                    ></div>
                    ...
                    <span
                      className="relative text-sm font-semibold text-gray-700 dark:text-gray-300 group-hover/link:text-transparent group-hover/link:bg-gradient-to-r group-hover/link:bg-clip-text transition-all duration-300"
                      style={{
                        backgroundImage: `linear-gradient(90deg, ${product.gradient})`,
                      }}
                    >
                      {t("moreDetails")}
                    </span>
        ...
        <div className="text-center mt-16">
          <div className="mb-4 flex items-center justify-center gap-2">
            <div
              className={`w-3 h-3 rounded-full ${canInstall ? "bg-green-400" : "bg-red-400"} animate-pulse`}
            ></div>
            <span
              className={`text-sm font-medium ${canInstall ? "text-green-600 dark:text-green-400" : "text-red-600 dark:text-red-400"}`}
            >
              {canInstall
                ? "Сompatible with your browser"
                : "Requires Chrome on PC to Add Extension"}
            </span>
          </div>
          ...
          {canInstall ? (
            ...
            >
              ...
              <div className="relative flex items-center gap-3">
                ...
                <svg
                  className="w-5 h-5 ml-1 text-white transition-transform duration-300 group-hover:translate-x-1 group-hover:rotate-12"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
