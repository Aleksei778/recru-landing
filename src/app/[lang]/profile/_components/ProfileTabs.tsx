  ...
  return (
    <div>
      <h2 className="text-2xl font-bold mb-4">
        {t("profile.managerDashboard")}
      </h2>

      <div className="p-5 bg-gray-50 dark:bg-gray-700/30 rounded-lg shadow">
        <p>
          <b>{t("profile.name")}:</b> {sessionUser.name}
        </p>
        <p>
          <b>{t("profile.email")}:</b> {sessionUser.email}
        </p>
          ...
          >
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-gray-500 text-sm">{req.artist_nickname}</p>
              </div>

              <span className="px-2 py-1 text-sm rounded bg-gray-200 dark:bg-gray-800">
                {req.status}
              </span>
            </div>
          </a>
