  ...
  const validateStep = (step: number): boolean => {
    ...
    if (step === 1) {
      if (!formData.firstName.trim())
        newErrors.firstName = t("tenty.requiredField");
      if (!formData.lastName.trim())
        newErrors.lastName = t("tenty.requiredField");
    ...
    if (step === 2) {
      if (!formData.reportingPlatform)
        newErrors.reportingPlatform = t("tenty.requiredField");
      if (!formData.reportType) newErrors.reportType = t("tenty.requiredField");
      if (!formData.contentType)
        newErrors.contentType = t("tenty.requiredField");
    ...
    if (step === 3) {
      ...
      if (!formData.ownershipType)
        newErrors.ownershipType = t("tenty.requiredField");
      if (!formData.ownershipExplanation.trim()) {
        ...
        newErrors.ownershipExplanation = t("tenty.minCharacters", {
          count: 100,
        });
      }
    }
    ...
    if (step === 4) {
      ...
      if (!formData.agreeAccuracy)
        newErrors.agreeAccuracy = t("tenty.agreeRequired");
      if (!formData.agreePenalties)
        newErrors.agreePenalties = t("tenty.agreeRequired");
    }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleChange("additionalContacts", e.target.value)
                  }
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg dark:bg-gray-800 dark:border-gray-700"
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleChange("reportingPlatform", e.target.value)
                  }
                  className={`w-full px-4 py-2 border rounded-lg dark:bg-gray-800 dark:border-gray-700 ${
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) =>
                  handleChange("reportingReason", e.target.value)
                }
                rows={6}
                maxLength={2000}
                className={`w-full px-4 py-2 border rounded-lg dark:bg-gray-800 dark:border-gray-700 ${
          ...
          <div className="space-y-6">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                ...
                <span className="text-sm text-gray-500 dark:text-gray-400 ml-2">
                  {formData.ownershipExplanation.length}/1000{" "}
                  {t("tenty.characters")}
                </span>
              </label>
              <textarea
                ...
                onChange={(e) =>
                  handleChange("ownershipExplanation", e.target.value)
                }
                rows={8}
                maxLength={1000}
                className={`w-full px-4 py-2 border rounded-lg dark:bg-gray-800 dark:border-gray-700 ${
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium">
                      {formData.phoneNumber || t("tenty.notProvided")}
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-4 p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
              ...
              <div className="flex items-start gap-3">
                <input
                  ...
                  onChange={(e) =>
                    handleChange("agreeAccuracy", e.target.checked)
                  }
                  className="mt-1"
                />
                <div>
              ...
              <div className="flex items-start gap-3">
                <input
                  ...
                  onChange={(e) =>
                    handleChange("agreePenalties", e.target.checked)
                  }
                  className="mt-1"
                />
                <div>
