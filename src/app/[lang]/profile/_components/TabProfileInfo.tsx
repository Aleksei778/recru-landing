...
export default function TabProfileInfo({
  user,
  userData,
}: TabProfileInfoProps) {
  ...
  const avatarSrc =
    userData?.avatar_url || user?.image || "/default-avatar.png";
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <div className="p-5 bg-linear-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-900/10 rounded-xl border border-blue-100 dark:border-blue-800">
          ...
          {(!userData?.active_plan ||
            userData.active_plan.toLowerCase() === "free") && (
            <Link
                  ...
                  style={{
                    width: `${Math.max(
                      ...
                      Math.min(
                        100,
                        ((new Date().getTime() -
                          new Date(userData.subscription_end).getTime()) /
                          (30 * 24 * 60 * 60 * 1000)) *
                          100,
                      ),
                    )}%`,
